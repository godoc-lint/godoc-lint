...
*Godoc-Lint* is a *little* opinionated linter for Go documentation practice, also known as *Go Doc* or *godoc* (See [*Go Doc Comments*][godoc-ref]), ready to be used **out of the box** without further configuration. It is highly recommended when developing **reusable Go modules, like SDKs, API clients, or special-purpose libraries,** which need consistent/standard documentation style and nice DevEx in IDEs or on [pkg.go.dev](https://pkg.go.dev).
